    ...
    let ballX = cw / 2 - ballSize / 2;  //wielkosć piłki x
    let ballY = ch / 2 - ballSize / 2;  //wielkosć piłki y
    ...
    function ball() {
      ...
      ballX += ballSpeedX;   ///koreslanie szybkości piłki
      ballY += ballSpeedY;
    ...
    function table() {
      ...
      ctx.fillStyle = 'black';  //stól do grania

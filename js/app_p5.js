...
function setup()
{
  createCanvas(1600,1000); //wielkość canvasu (szerokość, wysokość)
...
//Rakietki
    ...
    rightPaddle.posX = windowWidth -90 ; //pozycja startowa prawej paletki (X)
...
var drawField = function() {
    stroke(halfColor);
    strokeWeight(1);
    line(windowWidth/2, 0, windowWidth/2, windowHeight +70); //linia środkowa
    noStroke();
    fill(borderColor);
